...
/* -----  2018/10/27  Problem: ARC 034 C / Link: http://arc034.contest.atcoder.jp/tasks/arc034_c  ----- */
/* ------問題------
...
最低でB!,最大でA!である。
B!にかけてもいいのはA!の約数である必要である。
これはA!/B!にでてくる数なので、結局約数の選択数を求めれば良い。

----解説ここまで---- */

map<int, int>cnt;
void make_factor(long long  n) {
