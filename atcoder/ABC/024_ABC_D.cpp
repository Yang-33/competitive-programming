...
/* -----  2019/04/09  Problem: ABC 024 D / Link: http://abc024.contest.atcoder.jp/tasks/abc024_d  ----- */
...
int main() {
	...
	LL a, b, c; cin >> a >> b >> c;
	mint d = mint(b*c - a * b - a * c);
	mint r = mint(a*c - b * c) / d;
	mint x = mint(a*b - b * c) / d;
	cout << r.get() << " " << x.get() << endl;
