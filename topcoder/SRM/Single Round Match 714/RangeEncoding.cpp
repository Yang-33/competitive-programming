...
/* -----  xtimex  Problem: SRM714div2 easy / Link:  ----- */
/* ------問題------

厳密な増加列arrが与えられるのでその中に含まれる連続列の個数を求めよ。

-----問題ここまで----- */
/* -----解説等-----

順番に見ていき、連続列でなければ参照用の値を変更し、個数を求めればよい。
